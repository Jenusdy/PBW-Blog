...
<div class="wrapper">
	<div class="header header-filter" style="background-image: url('<?php echo base_url();?>assets/img/angular.jpg">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<h1 class="title text-center">Tutorial</h1>
					<h6 class="title text-center">Create at <?php echo date('Y-M-D'); ?></h6>
				</div>
			</div>
		</div>
	</div>
